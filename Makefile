# Convenience targets for AFKTY Library.
...
PLACE_FILE ?= AFKTY Library.rbxlx
TEST_PLACE_FILE ?= AFKTY Library Tests.rbxlx
...
help:
	...
	@echo   test-verbose  Run unit tests with AFKTY logs enabled
